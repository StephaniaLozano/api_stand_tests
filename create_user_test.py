...
# Función de prueba negativa caracteres
...
# Función de prueba negativa resgistro sin nombre
...
# Prueba 4. Error
# El parámetro "firstName" contiene 13 caracteres
def test_create_user_16_letter_in_first_name_get_error_response():
    negative_assert_symbol("Аааааааааааааааа")

# Prueba 5. Error
# El parámetro "firstName" contiene espacios
def test_create_user_has_space_in_first_name_get_error_respons():
    negative_assert_symbol("A Aaa")

# Prueba 6. Error
# El parámetro "firstName" contiene caracteres espaciales
